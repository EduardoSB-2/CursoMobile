import 'package:sa_registroponto/views/home_view.dart';
import 'package:sa_registroponto/views/registro_view.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            ElevatedButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => HomeView())), child: Text("Login")),
            TextButton(
